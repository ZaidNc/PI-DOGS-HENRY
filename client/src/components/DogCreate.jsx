...
export default function DogCreate() {
  ...
  function validate(input) {
    ...
    if (
      !input.life_time_min ||
      !/^[0-9]\d*(\.\d+)?$/.test(input.life_time_min)
    ) {
    ...
    if (
      !input.life_time_max ||
      !/^[0-9]\d*(\.\d+)?$/.test(input.life_time_max)
    ) {
  ...
  return (
    <div>
      <form className={s.form} onSubmit={(e) => handleSubmit(e)}>
        ...
        <div>
          <br />
          <label htmlFor="height_min">Tamaño en cm *</label>
          <br />
          <input
            className={s.input}
            autocomplete="off"
        ...
        <div>
          <br />
          <label htmlFor="weight_min">Peso en kg *</label>
          <br />
          <input
            className={s.input}
            autocomplete="off"
        ...
        <div>
          <br />
          <label htmlFor="life_time_min">Tiempo de Vida en Años *</label>
          <br />
          <input
            className={s.input}
            autocomplete="off"
